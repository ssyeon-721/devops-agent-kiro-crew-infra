...
| # | 제약 | 대응 |
|---|------|------|
| C1 | DevOps Agent가 Preview (2025년 12월 발표) | 검증 계정으로 진행. 고객사 제안은 GA 후 |
...
| R3 | Preview 사양 변경으로 중간에 동작이 달라짐 | 중간 | 각 Phase 결과에 실행 일자 기록 |
...
| 대상 | 이유 | 대안 |
|------|------|------|
| DevOps Agent Space | Preview 단계이며 Terraform 리소스 미제공 | 콘솔 수동 구성. 설정값을 README에 기록 |
